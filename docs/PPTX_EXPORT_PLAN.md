...
- Editable text boxes for titles, subtitles, body copy, bullets, metrics, and table cells.
...
- Native editable layouts for agenda, data tables, charts, flow diagrams, timeline, logic chart, comparison, SWOT, profile, plan, team, and promise pages.
...
- Add richer slide notes for speaker script.
